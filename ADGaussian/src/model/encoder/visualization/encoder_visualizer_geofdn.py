...
from ..encoder_geofdn import EncoderGeoFDN
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_geofdn_cfg import EncoderVisualizerGeoFDNCfg
...
class EncoderVisualizerGeoFDN(
    EncoderVisualizer[EncoderVisualizerGeoFDNCfg, EncoderGeoFDN]
):
    def visualize(
        self,
