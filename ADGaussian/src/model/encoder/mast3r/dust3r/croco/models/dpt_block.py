...
class FeatureFusionBlock_custom(nn.Module):
    ...
    def forward(self, *xs):
        ...
        if len(xs) > 2:
            ...
            if xs[-1] is not None:
                output = self.skip_add.add(output, self.prompUnit(xs[-1]))
