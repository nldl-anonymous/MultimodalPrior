...
def render_cuda(
    ...
    for i in range(b):
        ...
        image, radii, accum_weights_ptr, accum_weights_count, accum_max_count = rasterizer(
        ...
        all_accum_weights.append(accum_weights_ptr)
        all_accum_area.append(accum_weights_count)
        all_area_max.append(accum_max_count)
    return torch.stack(all_images), torch.stack(all_accum_weights), torch.stack(all_accum_area), torch.stack(all_area_max)
